...
//            FragmentAnimation.setDefaultFragmentAnimation(fragmentTransaction);
    ...
    public boolean isReadSmsPermissionGranted() {
        if (Build.VERSION.SDK_INT >= 23) {
            if (checkSelfPermission(Manifest.permission.READ_SMS)
                ...
                ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.READ_SMS}, 3);
                return false;
            }
        } else {
            //permission is automatically granted on sdk<23 upon installation
     ...
     * @param message
     */
    public void defaultToast(Context context,String message){
    ...
    public void customToast(Context context,String message){
        ...
        View layout = inflater.inflate(R.layout.design_custom_toast,
